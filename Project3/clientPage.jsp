...
<body>
  ...
  <hr>
  <p class="info">You are connected to the Project 3 Enterprise System database as a <span>client-level</span> user.<br>
  Please enter any SQL query or update command in the box below.</p>

  <form action="/Project-3/ClientUserApp" method="post">
